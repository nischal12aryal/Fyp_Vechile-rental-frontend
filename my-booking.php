...
// Retrieve booking details, including VehicleId
$bookingQuery = "SELECT VehicleId FROM tblbooking WHERE userEmail = :email AND Status = 1 LIMIT 1";
$stmt = $dbh->prepare($bookingQuery);
...
$car_id = $booking['VehicleId']; // Store vehicle ID for review form
?>
            <style>
    .review-section {
        margin-top: 20px;
...
if (isset($_SESSION['message'])): ?>
    <div style="padding: 10px; background: #dff0d8; color: #3c763d; border: 1px solid #d6e9c6; margin-bottom: 10px;">
...
<div class="review-section">
    ...
    <input type="hidden" name="car_id" value="<?php echo $car_id; ?>">
        ...
        <textarea name="review" rows="4" placeholder="Write your thoughts here..." required></textarea>
