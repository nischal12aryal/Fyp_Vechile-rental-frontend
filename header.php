  ...
  <div class="default-header">
    <div class="container">
      <div class="row">
        ...
        <img src="assets/images/sitelogo.png" alt="Website Logo" style="height:60px;">
        </div>
...
foreach($results as $result)
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="deposit.php">Security Deposit</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <!-- <li><a href="page.php?type=insurance">Insurance</a></li> -->
